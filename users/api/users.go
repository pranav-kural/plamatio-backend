...
func AddUser(ctx context.Context, newUser *models.UserRequestParams) (*models.User, error) {
	...
	r, err := UsersTable.InsertUser(ctx, newUser.FirstName, newUser.LastName)
	if err != nil {
		return nil, err
	}
	// Return the user.
...
func UpdateUser(ctx context.Context, updatedUser *models.User) (*models.UserChangeRequestStatus, error) {
	...
	err := UsersTable.UpdateUser(ctx, updatedUser.FirstName, updatedUser.LastName, updatedUser.ID)
	if err != nil {
